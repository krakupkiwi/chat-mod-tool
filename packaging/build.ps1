...
Push-Location $frontendDir
try {
    # Set version env var so electron-builder picks it up if not already in package.json
...
if (-not $installer) {
    # electron-builder sometimes uses the productName directly
...
if ($installer) {
    ...
    Write-Host "  Warning: installer .exe not found in $outDir — check electron-builder output above" -ForegroundColor Yellow
}
...
Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Cyan
Write-Host ""
Write-Host "  Next steps for distribution:" -ForegroundColor Gray
Write-Host "    1. Test installer on a clean Windows 11 VM" -ForegroundColor Gray
Write-Host "    2. Submit twitchids-backend.exe to Microsoft MAPS / Defender portal" -ForegroundColor Gray
Write-Host "    3. Create a GitHub Release and upload the .exe + .yml update manifest" -ForegroundColor Gray
